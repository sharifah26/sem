	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					Newspaper/Print<input value="Newspaper/Print" <?php if(in_array("Newspaper/Print",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					Social Media<input value="Social Media" <?php if(in_array("Social Media",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					</td>
				</tr>
